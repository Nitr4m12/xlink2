...
public:
    ...
    const char* getBoneName(ResAssetCallTable const&) const;
    ...
    const char* getOverwriteBoneName(u32) const;
    ...
    u32 getTriggerOverwriteParamId_(u32) const;

    u32 getAssetBitFlag_(ResAssetCallTable const&) const;
